...
public class AttendanceStudentFragment extends Fragment {
    ...
    AttendanceStudentFragmentAdapter adapter;
        ...
        JsonArrayRequest request=new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                try {
                    ...
                    adapter = new AttendanceStudentFragmentAdapter(getContext(),name,uid,bundle.get("iuid").toString(),bundle.get("batchuid").toString(),bundle.get("subject_id").toString(),f_manager);
